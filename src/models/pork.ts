export const porks = [
	...
	,{
		...
		name : 'Pork BBQ(4 skewers/ 1 skewer)',
		description : 'Delicious marinated pork sliced, skewered until its perfectly done.',
		image: 'pork/PorkBBQ.jpg',
		price : '10.99/2.75'
